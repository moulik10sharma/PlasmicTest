...
import sty from "./PlasmicButton.module.css"; // plasmic-import: m6Sry-Ld2YY2/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: rgb71yFF_NEb/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: hH_Q10ySLllt/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__t9Llr)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__tbY9)}
                role={"img"}
              />
            ),
