...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: 7RxYTt11e4j3/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: HyNkCUcIkWdQ/icon
import ChecksvgIcon from "../website_starter/icons/PlasmicIcon__Checksvg"; // plasmic-import: rgb71yFF_NEb/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__vc3GA)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg___8Ny6P)}
              role={"img"}
            />
          ),
